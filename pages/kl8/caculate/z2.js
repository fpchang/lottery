 ...
 * 合理区间的开奖结果
 */
import {getRandomRedBall,generateHappy8Numbers} from "./getRandom.js"
import { compare } from "./common.js";
import { kl8_data } from "../kl8_data.js";
import {getMiss} from "../miss/miss.js";
...
function caculate(dan=[]) {
	let thread = 0;
	let result=null;
	while(result==null){
		let list = generateHappy8Numbers(dan);
...
const missList2= getMiss(2);
console.log("1111",missList2);
const dan =missList2[1][0].split(",");
//console.log(dan,generateHappy8Numbers(dan))
for(let i=0;i<8;i++){
	caculate(dan);
}
